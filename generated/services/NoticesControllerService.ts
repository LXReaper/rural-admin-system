...
export class NoticesControllerService {
  ...
  public static postNoticeUsingPost(
    ...
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/management/notices/add",
  ...
  public static deleteNoticeUsingPost(
    ...
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/management/notices/delete",
      body: deleteRequest,
      errors: {
        401: `Unauthorized`,
        403: `Forbidden`,
  ...
  public static getNoticesVoByIdUsingGet(
    ...
    return __request(OpenAPI, {
      method: "GET",
      url: "/api/management/notices/get/vo",
      query: {
        id: id,
      },
      errors: {
  ...
  public static setReadNotificationsUsingPost(
    ...
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/management/notices/isRead/set",
      query: {
        id: id,
      },
      errors: {
  ...
  public static listNoticesByPageUsingPost(
    ...
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/management/notices/list/page",
  ...
  public static listNoticesVoByPageUsingPost(
    ...
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/management/notices/list/page/vo",
      body: noticesQueryRequest,
      errors: {
        401: `Unauthorized`,
        403: `Forbidden`,
  ...
  public static publishNotificationsUsingPost(
    ...
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/management/notices/publish",
