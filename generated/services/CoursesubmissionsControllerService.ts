...
export class CoursesubmissionsControllerService {
  ...
  public static addCoursesubmissionUsingPost(
    ...
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/task/study/courseSubmissions/add",
  ...
  public static deleteCoursesubmissionUsingPost(
    ...
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/task/study/courseSubmissions/delete",
      body: deleteRequest,
      errors: {
        401: `Unauthorized`,
        403: `Forbidden`,
  ...
  public static getCoursesubmissionsByIdUsingGet(
    ...
    return __request(OpenAPI, {
      method: "GET",
      url: "/api/task/study/courseSubmissions/get",
      query: {
  ...
  public static listCoursesubmissionsByPageUsingPost(
    ...
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/task/study/courseSubmissions/list/page",
  ...
  public static updateCoursesubmissionUsingPost(
    ...
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/task/study/courseSubmissions/update",
